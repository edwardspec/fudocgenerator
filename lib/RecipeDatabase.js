...
class RecipeDatabase {
	...
	/**
	 * Add "fuel item -> produced power" recipes for Combustion Generator.
	 */
	loadCombustionFuels() {
		var combustionConf = AssetDatabase.getData( 'objects/power/isn_thermalgenerator/isn_thermalgenerator.object' );
		...
		for ( var [ itemCode, fuelDuration ] of Object.entries( combustionConf.acceptablefuel ) ) {
			...
			this.add( 'Combustion Generator', inputs, outputs );
		}
	}
