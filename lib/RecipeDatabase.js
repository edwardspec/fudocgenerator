			...
			for ( var spawnGroup of spawnProfile.groups ) {
				...
				for ( var [ individualChance, spawnTypeName ] of util.normalizeWeights( pool ) ) {
					...
					if ( Array.isArray( monsterType ) ) {
						// TODO: spawntypes with different possible monsters are not yet supported.
						// (these are mostly vanilla monsters like 99% Gleap and 1% Fire Gleap).
						// For now, we only show the first monster there.
						monsterType = monsterType[0][1];
					}
