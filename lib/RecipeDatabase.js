...
const Recipe = require( './Recipe' ),
	...
	CraftingStationDatabase = require( './CraftingStationDatabase' ),
	util = require( './util' );
...
class RecipeDatabase {
	 ...
	 */
	addNativeCraftingRecipe( loadedData ) {
		...
		this.add( station,
			util.craftingInputToRecipeInput( loadedData.input ),
			util.craftingInputToRecipeInput( loadedData.output )
		);
	}
