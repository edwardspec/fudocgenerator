...
const { config, ChunkWriter, DiffableResult, PageNameRegistry, WikiStatusCache } = require( '..' ),
...
class ResultsWriter {
	...
	finalize() {
		...
		this.diffableResult.saveToFile( this.outputDir + '/previousResult.serialized' );
	}
