...
module.exports.FunctionDatabase = require( './FunctionDatabase' );
...
module.exports.SpawnTypeDatabase = require( './SpawnTypeDatabase' );

module.exports.Tenant = require( './entity/Tenant' );
module.exports.TenantDatabase = require( './TenantDatabase' );
...
module.exports.SaplingDatabase = require( './SaplingDatabase' );
module.exports.StatusEffect = require( './entity/StatusEffect' );
module.exports.StatusEffectDatabase = require( './StatusEffectDatabase' );

module.exports.WeatherPool = require( './entity/WeatherPool' );
module.exports.WeatherPoolDatabase = require( './WeatherPoolDatabase' );
...
module.exports.StarDatabase = require( './StarDatabase' );
