...
module.exports.loadModFile = function ( filename ) {
	...
	// FIXME: some input files have "new line" character within the JavaScript strings (between " and ").
...
module.exports.craftingInputToRecipeInput = function ( nativeCraftingInput ) {
	...
	nativeCraftingInput.forEach( function ( ingredient ) {
		inputs[ingredient.item] = { count: ingredient.count };
	} );
 ...
 * they only work in-game, and we don't really care to implement them here.
