...
class ResultsWriter {
	...
	writeIntoCargoDatabase( partitionKey, wikitext ) {
		// TODO: use partitionKey to assign the same item/recipe/node to the same Chunk subpage,
		// so that one item being changed in chunk #10 wouldn't cause overwriting of all pages
		// from chunk #11 to chunk #100 (or whatever is the last chunk).
