...
class RecipeSide {
	...
	/**
	 * Add 1 modular tree stem (something that has a valid stem ID) to this RecipeSide object.
	 *
	 * @param {string} stemName
	 * @return {this}
	 */
	addStem( stemName ) {
		return this.addComponent( RecipeComponent.newStem( stemName ) );
	}

	/**
	 * Add 1 modular tree foliage (something that has a valid foliage ID) to this RecipeSide object.
	 *
	 * @param {string} foliageName
	 * @return {this}
	 */
	addFoliage( foliageName ) {
		return this.addComponent( RecipeComponent.newFoliage( foliageName ) );
	}
