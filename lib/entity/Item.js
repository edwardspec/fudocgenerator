...
class Item {
	...
	constructor( asset, overrideId = '' ) {
		...
		if ( this.builder && this.level !== undefined &&
			this.builder.match( /\/(fubuildarmor|buildunrandweapon|buildwhip|fubuildmagnorb|buildboomerang|fubuildchakram|buildbow|neb-buildbow|buildfist|fubuildunrandshield)\.lua$/ )
		) {
