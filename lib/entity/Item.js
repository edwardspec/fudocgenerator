...
class Item {
	...
	getMetadata() {
		...
		// TODO: some items have altAbilityType (string) instead of altAbility inline structure.
		// They use the contents of "*.weaponability" asset. We need to parse/use those assets.
