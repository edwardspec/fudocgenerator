...
class ChunkWriter {
	 ...
	 * @param {string} groupsConfig.filename Name of output file. This file will be overwritten.
	 * @param {string} groupsConfig.headerText Can contain "$1" (will be replaced with the number of chunk).
	 * @param {string} groupsConfig.footerText
	 * @param {int} groupsConfig.maxChunkSizeBytes Hard limit on the size of chunk (chunk will be split if this is exceeded).
	...
	constructor( groupsConfig ) {
		// Copy fields like "filename", "header", "groups", etc. from groupsConfig.
