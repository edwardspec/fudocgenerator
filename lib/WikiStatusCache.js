...
class WikiStatusCache {
	...
	async updateCache() {
		...
		const bot = new MWBot( { apiUrl: config.mediawikiApiUrl } );
		for ( const namespace of config.namespacesForPageExistsCache ) {
